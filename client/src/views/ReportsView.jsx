...
export default forwardRef(function ReportsView({ user, onOpenReport, reportsPersonId, setReportsPersonId, activeTrade, onNavigate, readOnly = false }, ref) {
  ...
  const roleGroupsByTrade = {
    ...
    Safety: [
      { level: 1, label: 'Safety Assistants' },
      { level: 2, label: 'Safety Officers' },
      { level: 3, label: 'Safety Supervisors' },
      { level: 4, label: 'Safety Managers' },
      { level: 5, label: 'Safety Directors' },
      { level: 6, label: 'Project Management' },
      { level: 7, label: 'CEO' },
    ],
  };
