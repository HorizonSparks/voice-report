...
const ROLE_GROUPS_BY_TRADE = {
  Electrical: [
    { level: 1, labelKey: 'people.helpers' },
    { level: 2, labelKey: 'people.journeymen' },
    { level: 3, labelKey: 'people.foremen' },
    { level: 4, labelKey: 'people.generalForemen' },
    { level: 5, labelKey: 'people.superintendents' },
    { level: 6, label: 'Project Management' },
    { level: 7, label: 'CEO' },
    { level: -1, label: 'Other' },
  ],
  Instrumentation: [
    { level: 1, label: 'Junior Techs' },
    { level: 2, label: 'Instrument Techs' },
    { level: 3, label: 'Senior Techs' },
    { level: 4, label: 'Instrument Leads' },
    { level: 5, label: 'Instrument Supervisors' },
    { level: 6, label: 'Project Management' },
    { level: 7, label: 'CEO' },
    { level: -1, label: 'Other' },
  ],
  'Pipe Fitting': [
    { level: 1, label: 'Helpers' },
    { level: 2, label: 'Journeymen' },
    { level: 2, label: 'Boilermakers', roleTitle: 'Boilermaker' },
    { level: 3, label: 'Foremen' },
    { level: 4, label: 'General Foremen' },
    { level: 5, label: 'Superintendents' },
    { level: 6, label: 'Project Management' },
    { level: 7, label: 'CEO' },
    { level: -1, label: 'Other' },
  ],
  ...
  Safety: [
    { level: 3, label: 'Safety Coordinators' },
    { level: 4, label: 'Safety Officers' },
    { level: 5, label: 'HSE Managers' },
    { level: 6, label: 'Site Safety Directors' },
    { level: 7, label: 'CEO' },
    { level: -1, label: 'Other' },
  ],
  Millwright: [
    { level: 1, label: 'Millwright Helpers' },
    { level: 2, label: 'Journeyman Millwrights' },
    { level: 3, label: 'Millwright Foremen' },
    { level: 4, label: 'Millwright General Foremen' },
    { level: 5, label: 'Millwright Superintendents' },
    { level: 6, label: 'Project Management' },
    { level: 7, label: 'CEO' },
    { level: -1, label: 'Other' },
  ],
